...
import (
	...
	"github.com/vpiyush/go-kit-truss/watermark-service/handlers"
...
func NewEndpoints(service pb.WatermarkServer) svc.Endpoints {
	// Business domain.
	...
	// Endpoint domain.
	var (
		getdocumentEndpoint = svc.MakeGetDocumentEndpoint(service)
		adddocumentEndpoint = svc.MakeAddDocumentEndpoint(service)
		watermarkEndpoint   = svc.MakeWatermarkEndpoint(service)
	)
...
func Run(cfg svc.Config) {
	...
	go func() {
		...
		s := grpc.NewServer()
		pb.RegisterWatermarkServer(s, srv)
